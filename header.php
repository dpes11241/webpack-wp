...
<div id="page" class="site">
	...
	<h1>Webpack with Sass Loader , mini-css-extract-plugin and css loader </h1>
	<h5>Use following commands on terminal for development: </h5>
	<ul>
	<li>1) npm install</li>
	<li>2) npm run dev</li>
	<li><b> Note:</b> Entry path is src/app.scss</li>
	<li><b> Note:</b>  Output path is dist/app.css</li>
	</ul>
